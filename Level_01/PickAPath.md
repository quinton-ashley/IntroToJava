...
If the number the user entered, their choice, is a valid option change the `path` variable to the user's input. Otherwise alert the user they've made an invalid choice.
